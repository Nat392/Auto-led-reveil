...
| **Daylight Harvesting** | `DaylightHarvestingEstimator.kt`, `DaylightHarvestingScheduler.kt`, `DaylightHarvestingWorker.kt`, `DaylightFadeRunner.kt`, `DaylightHarvestingStateStore.kt` | Ajuste en continu la lumière artificielle de la Chambre et de la Cuisine selon la radiation solaire (`shortwave_radiation`, W/m²) en suivant la loi psychophysique de Weber-Fechner : pleine intensité à 0 W/m², extinction complète à partir d'un seuil propre à chaque zone (calibré sur la taille de sa fenêtre — Chambre ~74 cm → 400 W/m², Cuisine ~200-225 cm → 150 W/m²). |
