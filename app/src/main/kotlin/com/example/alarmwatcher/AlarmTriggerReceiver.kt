        ...
        try {
            if (bulbMac.isNotBlank()) {
                ...
                val serviceIntent = Intent(context, SunriseService::class.java).apply {
                    ...
                    putExtra(SunriseService.EXTRA_TARGET_R, intent.getIntExtra("target_r", 220))
                    putExtra(SunriseService.EXTRA_TARGET_G, intent.getIntExtra("target_g", 240))
                    putExtra(SunriseService.EXTRA_TARGET_B, intent.getIntExtra("target_b", 255))
                    putExtra(SunriseService.EXTRA_TARGET_WHITE, intent.getIntExtra("target_white", 0))
